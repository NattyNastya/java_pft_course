...
public class ContactHelper extends BaseHelper {
  ...
  public Contacts all() {
    ...
    for (WebElement element : elements) {
      ...
      ContactData contact = new ContactData().withId(id).withFirst_name(firstname).withLast_name(lastname).withGeneral_address(address).withAllPhones(allPhones).withAllEmails(allEmails);
