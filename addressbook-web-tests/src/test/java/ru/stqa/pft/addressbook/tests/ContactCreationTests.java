...
public class ContactCreationTests extends TestBase {
  ...
  public void testContactCreation() {
    ...
    ContactMainData mainData = new ContactMainData().withFirst_name("Konstantin").withLast_name("Mikhin").withNickname("Super_duper").withTitle("Surgeons").withContact_company("1st clinic").withGeneral_address("Suhaya str.").withHome_phone("-").withMobile_phone("+375290000000").withWork_phone("+375170000000").withFax("-");
    ...
    app.contact().create(mainData, additionalData, secondaryData);
  ...
  public void testBadContactCreation() {
    ...
    ContactMainData mainData = new ContactMainData().withFirst_name("Konstantin'").withLast_name(null).withNickname(null).withTitle(null).withContact_company(null).withGeneral_address(null).withHome_phone(null).withMobile_phone(null).withWork_phone(null).withFax(null);
