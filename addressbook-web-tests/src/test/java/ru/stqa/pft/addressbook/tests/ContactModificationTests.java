...
public class ContactModificationTests extends TestBase {
  ...
  public void ensurePreconditions() {
    ...
    if (app.contact().all().size() == 0) {
      ...
      app.contact().create(
              new ContactMainData().withFirst_name("ANNA").withLast_name("Mikhin").withNickname("Super_duper").withTitle("Surgeons").withContact_company("1st clinic").withGeneral_address("Suhaya str.").withHome_phone("-").withMobile_phone("+375290000000").withWork_phone("+375170000000").withFax("-"),
  ...
  public void testContactModification() {
    ...
    ContactMainData mainData = new ContactMainData().withId(modifiedContact.getId()).withFirst_name("Anastasiya").withLast_name("Khamitsevich").withNickname("Super_duper-test").withTitle("The Surgeon").withContact_company("1st clinic").withGeneral_address("Suhaya str. - test").withHome_phone("13579").withMobile_phone("+375297777777").withWork_phone("+375175555555").withFax("11111111");
    ...
    app.contact().modifyContact(mainData, additionalData, secondaryData);
