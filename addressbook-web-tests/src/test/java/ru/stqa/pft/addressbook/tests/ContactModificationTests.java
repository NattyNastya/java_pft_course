...
public class ContactModificationTests extends TestBase {
  ...
  public void testContactModification() {
    ...
    ContactMainData mainData = new ContactMainData().withId(modifiedContact.getId()).withFirst_name("Anastasiya").withLast_name("Khamitsevich").withNickname("Super_duper-test").withTitle("The Surgeon").withContact_company("1st clinic").withGeneral_address("Suhaya str. - test").withHome_phone("13579").withMobile_phone("+375297777777").withWork_phone("+375175555555").withFax("11111111").withAddress_2("Second Test Address").withPhone_2("5557555").withNotes("Be healthy");
    ...
    app.contact().modifyContact(mainData, additionalData);
